...
def generate_options(x_data):
    """ Combine data into string """
    x_name = x_data["name"]
    x_description = x_data["description"]
    x_country = x_data["country"]
    return f"{x_name}, a {x_description} from {x_country}."
...
while continue_game:
    ...
    a_follow = option_a["follower_count"]
    b_follow = option_b["follower_count"]

    correct_answer = check_answer(player_ans, a_follow, b_follow)
